...
class Instruction(object):
	...
	def parse(self):
		self.parseType()
		self.parseFormat()
		self.opcode = self.insDict.get('opcode', 'NULL')
		self.rs = self.insDict.get('rs', 'NULL')
		self.rt = self.insDict.get('rt', 'NULL')
		self.rd = self.insDict.get('rd', 'NULL')
		self.shamt = self.insDict.get('shamt', 'NULL')
		self.funct = self.insDict.get('funct', 'NULL')
		self.immediate = self.insDict.get('immediate', 'NULL')
		self.address = self.insDict.get('address', 'NULL')
